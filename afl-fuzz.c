...
EXP_ST u32 queued_paths,              /* Total number of queued testcases */
           ...
           total_var_behaviors,       /* Total variable behaviors         */
...
static void maybe_update_plot_file(double bitmap_cvg, double eps) {
  ...
  static u32 prev_qp, prev_pf, prev_pnf, prev_ce, prev_md, prev_vb;
  static u64 prev_qc, prev_uc, prev_uh;

  if (prev_qp == queued_paths && prev_pf == pending_favored &&
      prev_pnf == pending_not_fuzzed && prev_ce == current_entry &&
      prev_qc == queue_cycle && prev_vb == total_var_behaviors && prev_uc == unique_crashes &&
  ...
  fprintf(plot_file,
          ...
          unique_hangs, max_depth, eps, total_var_behaviors); /* ignore errors */
...
EXP_ST void setup_dirs_fds(void) {
  ...
  fprintf(plot_file, "# unix_time, cycles_done, cur_path, paths_total, "
                     ...
                     "unique_hangs, max_depth, execs_per_sec, var_behaviors\n");
                     /* ignore errors */
