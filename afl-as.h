...
/* 
   ...
   - Only the trampoline_fmt and the non-setup __fafl_maybe_log code paths are
   ...
   - There is also not a whole lot to be gained by doing SHM attach at a
     fixed address instead of retrieving __fafl_area_ptr. Although it allows us
   ...
   - popf is *awfully* slow, which is why we're doing the lahf / sahf +
     ...
     https://groups.google.com/d/msg/fafl-users/MsajVf4fRLo/2u6t88ntUBIJ
   ...
   __fafl_prev_loc and __fafl_area_ptr being local to the object file (.lcomm),
...
static const u8* main_payload_32 = 
  ...
  "  movl __fafl_prev_loc, %edi\n"
  "  xorl %ecx, %edi\n"
  "  shrl $1, %ecx\n"
  "  movl %ecx, __fafl_prev_loc\n"
#else
  "  movl %ecx, %edi\n"
#endif /* ^!COVERAGE_ONLY */
  "\n"
  ...
  "\n"
  "  cmpb $0, __fafl_setup_failure\n"
  "  jne  __fafl_return\n"
  "\n"
  "  /* Map SHM, jumping to __fafl_setup_abort if something goes wrong.\n"
  ...
  "\n"
  "  pushl $4          /* length    */\n"
  "  pushl $__fafl_temp /* data      */\n"
  "  pushl $" STRINGIFY((FORKSRV_FD + 1)) "  /* file desc */\n"
  "  call  write\n"
  "  addl  $12, %esp\n"
  "\n"
  "  cmpl  $4, %eax\n"
  "  jne   __fafl_fork_resume\n"
  "\n"
  "__fafl_fork_wait_loop:\n"
  "\n"
  ...
  "  cmpl $0, %eax\n"
  "  jl   __fafl_die\n"
  "  je   __fafl_fork_resume\n"
  "\n"
  "  /* In parent process: write PID to pipe, then wait for child. */\n"
  "\n"
  "  movl  %eax, __fafl_fork_pid\n"
  "\n"
  "  pushl $4              /* length    */\n"
  "  pushl $__fafl_fork_pid /* data      */\n"
  "  pushl $" STRINGIFY((FORKSRV_FD + 1)) "      /* file desc */\n"
  "  call  write\n"
  "  addl  $12, %esp\n"
  "\n"
  "  pushl $0             /* no flags  */\n"
  "  pushl $__fafl_temp    /* status    */\n"
  "  pushl __fafl_fork_pid /* PID       */\n"
  "  call  waitpid\n"
  "  addl  $12, %esp\n"
  "\n"
  "  cmpl  $0, %eax\n"
  ...
  ".FOT_VARS:\n"
  "\n"
  "  .comm   __fafl_area_ptr, 4, 32\n"
  "  .comm   __fafl_setup_failure, 1, 32\n"
#ifndef COVERAGE_ONLY
  "  .comm   __fafl_prev_loc, 4, 32\n"
#endif /* !COVERAGE_ONLY */
  "  .comm   __fafl_fork_pid, 4, 32\n"
  "  .comm   __fafl_temp, 4, 32\n"
  "\n"
  ".FOT_SHM_ENV:\n"
  "  .asciz \"" SHM_ENV_VAR "\"\n"
  "\n"
...
static const u8* main_payload_64 = 
  ...
  "\n"
#ifndef COVERAGE_ONLY
  "  xorq __fafl_prev_loc(%rip), %rcx\n"
  "  xorq %rcx, __fafl_prev_loc(%rip)\n"
  "  shrq $1, __fafl_prev_loc(%rip)\n"
#endif /* ^!COVERAGE_ONLY */
  "\n"
#ifdef SKIP_COUNTS
  "  orb  $1, (%rdx, %rcx, 1)\n"
  ...
  "  /* Do not retry setup if we had previous failures. */\n"
  "\n"
  "  cmpb $0, __fafl_setup_failure(%rip)\n"
  "  jne __fafl_return\n"
  "\n"
  "  /* Check out if we have a global pointer on file. */\n"
  "\n"
#ifndef __APPLE__
  "  movq  __fafl_global_area_ptr@GOTPCREL(%rip), %rdx\n"
  "  movq  (%rdx), %rdx\n"
#else
  "  movq  __fafl_global_area_ptr(%rip), %rdx\n"
#endif /* !^__APPLE__ */
  "  testq %rdx, %rdx\n"
  "  je    __fafl_setup_first\n"
  "\n"
  "  movq %rdx, __fafl_area_ptr(%rip)\n"
  "  jmp  __fafl_store\n" 
  "\n"
  "__fafl_setup_first:\n"
  "\n"
  ...
  "\n"
  "  movq %rax, %rdx\n"
  "  movq %rax, __fafl_area_ptr(%rip)\n"
  "\n"
#ifdef __APPLE__
  "  movq %rax, __fafl_global_area_ptr(%rip)\n"
#else
  "  movq __fafl_global_area_ptr@GOTPCREL(%rip), %rdx\n"
  "  movq %rax, (%rdx)\n"
#endif /* ^__APPLE__ */
  ...
  "  /* In parent process: write PID to pipe, then wait for child. */\n"
  "\n"
  "  movl %eax, __fafl_fork_pid(%rip)\n"
  "\n"
  "  movq $4, %rdx                   /* length    */\n"
  "  leaq __fafl_fork_pid(%rip), %rsi /* data      */\n"
  "  movq $" STRINGIFY((FORKSRV_FD + 1)) ", %rdi             /* file desc */\n"
  CALL_L64("write")
  "\n"
  "  movq $0, %rdx                   /* no flags  */\n"
  "  leaq __fafl_temp(%rip), %rsi     /* status    */\n"
  "  movq __fafl_fork_pid(%rip), %rdi /* PID       */\n"
  CALL_L64("waitpid")
  "  cmpq $0, %rax\n"
  "  jle  __fafl_die\n"
  "\n"
  ...
  "  .comm   __fafl_area_ptr, 8\n"
#ifndef COVERAGE_ONLY
  "  .comm   __fafl_prev_loc, 8\n"
#endif /* !COVERAGE_ONLY */
  "  .comm   __fafl_fork_pid, 4\n"
  "  .comm   __fafl_temp, 4\n"
  "  .comm   __fafl_setup_failure, 1\n"

#else

  "  .lcomm   __fafl_area_ptr, 8\n"
#ifndef COVERAGE_ONLY
  "  .lcomm   __fafl_prev_loc, 8\n"
#endif /* !COVERAGE_ONLY */
  "  .lcomm   __fafl_fork_pid, 4\n"
  "  .lcomm   __fafl_temp, 4\n"
  "  .lcomm   __fafl_setup_failure, 1\n"

#endif /* ^__APPLE__ */

  "  .comm    __fafl_global_area_ptr, 8, 8\n"
  "\n"
  ".FOT_SHM_ENV:\n"
  "  .asciz \"" SHM_ENV_VAR "\"\n"
  "\n"
